...
/**
 * Constructeur ou Usine de construction d'objets graphique personnalisé.
 *
 */
public class InterfaceFXObjectConstruction {
	...
	/**
	 * Retourne un texte selon les coordonnées, taille de la police et valeur.
	 * @param X
	 * @param Y
	 * @param fontSize
	 * @param valeur
	...
	/**
	 * Retourne une progresse barre selon les coordonnées, largeur et hauteur.
	 * @param X
	 * @param Y
	 * @param width
	 * @param height
	...
	/**
	 * Retourne une zone de texte selon les coordonées, largeur, hauteur et taille de la police.
	 * @param X
	 * @param Y
	 * @param width
	 * @param height
	...
	/**
	 * Retourne un bouton selon les coordonnées, largeur, hauteur, taille de la police,
	...
	/**
	 * Retourne un label selon les coordonnées, largeur, hauteur et le titre.
	 * @param X
	 * @param Y
	 * @param width
	 * @param height
